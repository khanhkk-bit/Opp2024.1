...
public class Aims {
	...
	public static void initSetup() {
		...
		DigitalVideoDisc dvd1 = new DigitalVideoDisc("The King of zoo", "Animation", "Alex ", 87, 25.67f);
		DigitalVideoDisc dvd2 = new DigitalVideoDisc("War galaxy", "Science Fiction", "George Lucas", 87, 24.95f);
		DigitalVideoDisc dvd3 = new DigitalVideoDisc("Ali Ba BA", "Animation", 15.77f);
		store.addMedia(dvd1);
		store.addMedia(dvd2);
		store.addMedia(dvd3);
		...
		CompactDisc cd1 = new CompactDisc("Adele - 14", "Music", "Adele", 1500.98f);
		Track track1CD1 = new Track("All Night climbe (interlude)", 146);
		Track track2CD1 = new Track("To Be Loved", 404);
		Track track3CD1 = new Track("Woman Like Man", 304);
		cd1.addTrack(track1CD1);
		cd1.addTrack(track2CD1);
		cd1.addTrack(track3CD1);

		CompactDisc cd2 = new CompactDisc("The Gods We Should Punch", "Music", "Aurora", 2000.22f);
		Track track1CD2 = new Track("Everything HUST", 100 + 42);
		Track track2CD2 = new Track("Blood in the face", 180 + 30);
		...
		while (!back) {
			...
			case 3:
				...
				while (!foundToRemove) {
					...
					Media media = ((Cart) cart).searchToRemove(title);
					if (media != null) {
						clearConsole();
