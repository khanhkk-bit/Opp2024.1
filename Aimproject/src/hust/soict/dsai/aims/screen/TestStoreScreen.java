...
public abstract class TestStoreScreen extends Application {
	private static Store store;

	@Override
	public void start(Stage primaryStage) throws Exception {
		FXMLLoader fxmlLoader = new FXMLLoader(
				getClass().getResource("/hust/soict/dsai/aims/screen/view/TestStore.fxml"));
	...
	public static void initStore(Store store) {
		...
		Book book1 = new Book("Intro to A.I", "Math & Science", 25.5f);
